...
```
npm install zcore-lib --save
npm install zcore-payment-protocol --save
```

For client-side projects:

```
bower install zcore-lib --save
bower install zcore-payment-protocol --save
```
...
```javascript
var PaymentProtocol = require('zcore-payment-protocol');
